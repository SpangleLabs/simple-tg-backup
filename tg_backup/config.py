...
class BehaviourConfig:
    ...
    Attributes:
        ...
        recheck_media: Whether to check all media in messages again, when scanning messages which have already been
            archived and have not been edited.
    ...
    recheck_media: Optional[bool] = dataclasses.field(default=None)
    ...
    def merge(cls, b1: Optional["BehaviourConfig"], b2: "BehaviourConfig") -> "BehaviourConfig":
        ...
        return BehaviourConfig(
            ...
            recheck_media=b1.recheck_media if b1.recheck_media is not None else b2.recheck_media,
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "recheck_media": self.recheck_media,
    ...
    def from_dict(cls, data: dict) -> "BehaviourConfig":
        return cls(
            ...
            recheck_media=data.get("recheck_media"),
