...
def str_repr_parser() -> pp.ParserElement:
    val_float_expr = pp.common.real.set_name("value_float")
    ...
    val_bool_expr = pp.MatchFirst([pp.Literal("True"), pp.Literal("False")]).set_parse_action(lambda x: [x[0] == "True"]).set_name("value_bool")
    ...
    val_expr = pp.MatchFirst([val_float_expr, val_int_expr, val_none_expr, val_bool_expr, val_bytes_expr, val_str_expr, val_datetime_expr, val_class_expr, val_list_expr]).set_results_name("value")
